      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        >
          <div className="border-4 border-[#C9A84C] border-dashed px-6 py-6">
            ...
            <p className="text-gray-300 text-sm">Log in to continue your journey</p>
          </div>
        </div>
        ...
        <div className="bg-white border-2 border-gray-100 rounded-2xl p-6 flex flex-col gap-4">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-sm font-bold text-[#1B2B4B] mb-1.5">Password</label>
              <input
                type="password"
                placeholder="••••••••"
                value={password}
            ...
            <div className="text-right">
              <Link to="/reset-password" className="text-xs text-[#C9A84C] hover:underline font-semibold">
                Forgot password?
              </Link>
            </div>
            <button
          ...
          <button
            ...
            className="w-full border-2 border-gray-200 rounded-xl py-2.5 text-sm font-bold hover:border-[#1B2B4B] transition flex items-center justify-center gap-2"
          >
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link to="/signup" className="text-[#C9A84C] font-bold hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
